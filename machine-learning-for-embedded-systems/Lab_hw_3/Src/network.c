...
#define AI_NETWORK_MODEL_SIGNATURE     "ac8b714e829b7471ed823927fabd6bc9"
...
#define AI_TOOLS_DATE_TIME   "Mon Nov 29 10:57:45 2021"
...
AI_STATIC ai_array nl_2_output_array;   /* Array #8 */
AI_STATIC ai_array dense_3_output_array;   /* Array #9 */
AI_STATIC ai_array nl_4_output_array;   /* Array #10 */
...
AI_STATIC ai_tensor nl_2_output;   /* Tensor #9 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 60, 10, 1, 1), AI_STRIDE_INIT(4, 4, 240, 2400, 2400),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_5_bias_array.data = AI_PTR(weights + 273040);
    dense_5_bias_array.data_start = AI_PTR(weights + 273040);
